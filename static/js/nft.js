async function getNftsFormatted(){
    ...
    <div id='wallet'>
        <p>Wallet:</p>
        <p onclick='navigator.clipboard.writeText("sonytv.eth"); alert("Address Copied!")'>sonytv.eth</p>
        <p onclick='navigator.clipboard.writeText("0x5df54525f8f34b49622a15a9d65e4e0c9ed6a5c9"); alert("Address Copied!")'>0x5df5...a5c9</p>
    </div>
    `
